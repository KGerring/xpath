...
COMPILETIME = {
    CompiletimeException.INTERNAL: _(
        "There is an internal bug in 4XPath.  Please report this error code to support@4suite.org: %s"
    ),
...
RUNTIME = {
    RuntimeException.INTERNAL: _(
        "There is an internal bug in 4XPath.  Please report this error code to support@4suite.org: %s"
    ),
    RuntimeException.NO_CONTEXT: _(
        "An XPath Context object is required in order to evaluate an expression."
    ),
