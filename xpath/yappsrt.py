            ...
            if restrict and self.restrictions[i]:
                for r in restrict:
                    if r not in self.restrictions[i]:
                        raise StringException("Unimplemented: restriction set changed")
    ...
    def scan(self, restrict):
        ...
        while 1:
            ...
            if best_pat == "(error)" and best_match < 0:
                ...
                raise XPathSyntaxError(self.pos, msg)
...
class Parser:
    ...
    def _scan(self, type):
        ...
        if tok[2] != type:
            raise XPathSyntaxError(tok[0], "Trying to find " + type)
